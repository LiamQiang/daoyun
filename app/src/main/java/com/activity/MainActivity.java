...
public class MainActivity extends FragmentActivity implements View.OnClickListener {
    ...
    int[] arrayTabIcon={R.mipmap.ic_tabbar_home_nor,R.mipmap.ic_tabbar_my_nor};
    String[] arrayTabText={"首页","我的"};
    int[] arrayTabIconSel={R.mipmap.ic_tabbar_home_sel,R.mipmap.ic_tabbar_my_sel};
